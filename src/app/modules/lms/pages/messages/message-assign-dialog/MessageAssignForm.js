...
import "./MessageAssignForm.scss";
import { withRouter } from "react-router";

import { useIntl } from "react-intl";

// Validation schema
const MessageAssignSchema = Yup.object().shape({
  /*  Name: Yup.string()
...
export function MessageAssignForm_({
  saveAssignedUserForMessage,
  message,
  actionsLoading,
  onHide,
  match,
  ...
  console.log("MessageAssignForm -> entities", entities);
  ...
  return (
    <>
      <Formik
        ...
        initialValues={{ userIds: [], MessageId: cid }}
        validationSchema={MessageAssignSchema}
        onSubmit={(values) => {
          saveAssignedUserForMessage({ usersState, values });
        }}
      >
        {({ handleSubmit }) => (
          <>
...
export const MessageAssignForm = withRouter(MessageAssignForm_);
