  ...
  return (
    <>
      <Formik
        ...
        onSubmit={(values) => {
          if(!(values.A === 2 && values.B === 2 && values.C ===  2 && values.D === 2))
          {
            saveQuestion(values);
                ...
                <div className="form-group row">
                  ...
                  <div className="col-lg-8">
                    <input
                      className="go-out"
                      type="checkbox"
                      name="IsSectionEndQuestion"
                      checked={values.IsSectionEndQuestion}
                      onChange={() =>
                        setFieldValue(
                          "IsSectionEndQuestion",
                          !values.IsSectionEndQuestion
                        )
                      }
                    />
