...
import { VisualQuestionEditDialogHeader } from "./VisualQuestionEditDialogHeader";
import { VisualQuestionEditForm } from "./VisualQuestionEditForm";
import { useVisualQuestionsUIContext } from "../VisualQuestionsUIContext";

export function VisualQuestionEditDialog({ id, show, onHide }) {
  ...
  return (
    ...
    >
      <VisualQuestionEditDialogHeader id={id} />
      <VisualQuestionEditForm
