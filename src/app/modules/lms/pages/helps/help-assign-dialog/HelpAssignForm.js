...
import "./HelpAssignForm.scss";
import { withRouter } from "react-router";

import { useIntl } from "react-intl";

// Validation schema
const HelpAssignSchema = Yup.object().shape({
  /*  Name: Yup.string()
...
export function HelpAssignForm_({
  saveAssignedUserForHelp,
  help,
  actionsLoading,
  onHide,
  match,
  ...
  console.log("HelpAssignForm -> entities", entities);
  ...
  return (
    <>
      <Formik
        ...
        initialValues={{ userIds: [], HelpId: cid }}
        validationSchema={HelpAssignSchema}
        onSubmit={(values) => {
          saveAssignedUserForHelp({ usersState, values });
        }}
      >
        {({ handleSubmit }) => (
          <>
...
export const HelpAssignForm = withRouter(HelpAssignForm_);
