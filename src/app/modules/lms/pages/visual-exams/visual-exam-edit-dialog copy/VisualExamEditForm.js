...
export function VisualExamEditForm({
  ...
  useEffect(() => {
    console.log("VisualExamEditForm -> courseid", courseIdState);
    dispatch(topicsActions.fetchTopicsByCourseId(courseIdState));
  }, [courseIdState]);

  useEffect(() => {
    console.log("VisualExamEditForm -> topicIdState", topicIdState);
    dispatch(questionsActions.fetchQuestionsTagByTopicId(topicIdState));
    console.log("VisualExamEditForm -> questionState", questionState);
  }, [topicIdState]);
            ...
            <Modal.Body className="overlay overlay-block">
              ...
              <Form className="form form-label-right">
                <div className="form-group row">
                  ...
                  <div className="col-lg-12">
                    <Field
                      name="Name"
                      component={Input}
                      placeholder="VisualExam Name"
                      label="VisualExam Name"
                    />
                  </div>
                </div>
                <div className="form-group row">
                ...
                <div className="form-group row">
                  ...
                  <div className="col-lg-4">
                    <Select name="VisualExamTypeId" label="VisualExamTypeId">
