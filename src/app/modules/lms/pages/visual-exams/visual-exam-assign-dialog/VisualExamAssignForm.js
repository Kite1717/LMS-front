...
import "./VisualExamAssignForm.scss";
...
// Validation schema
const VisualExamAssignSchema = Yup.object().shape({
...
export function VisualExamAssignForm_({
  saveAssignedUserForVisualExam,
  visualExam,
  actionsLoading,
  onHide,
  match,
  ...
  console.log("VisualExamAssignForm -> entities", entities);
  ...
  const [tempEntities, setTempEntities] = React.useState(userState.entities);
  ...
  const handleAddition = () => {
    ...
    for (let i = 0; i < selectedUsersAdd.length; i++) {
      if (
        usersState.find((el) => el.id === selectedUsersAdd[i].id) === undefined
      )
  ...
  useEffect(() => {
    if (tempEntities !== null && tempEntities !== undefined) {
      let temp2 = [...entities];
  ...
  return (
    <>
      <Formik
        ...
        initialValues={{ userIds: [], VisualExamId: eid }}
        validationSchema={VisualExamAssignSchema}
        onSubmit={(values) => {
          if(values.Endtime !== "" && values.StartTime !== "" )
          saveAssignedUserForVisualExam({ usersState, values });
        }}
      >
            ...
            <Modal.Body className="overlay overlay-block">
              ...
              <div className="form-group row">
                    ...
                    <Field
                      ...
                      onChange={(e) => {
                        ...
                        for (
                          ...
                          if (
                            usersState.find((el) => el.id === user.id) ===
                              undefined 
                ...
                <div className="form-group row">
                  <div className="col-lg-12 mt-3">
                    <label>
                      Ekli Kullanıcılar (--Kişinin üzerine tıklayıp yada çoklu
                      seçerek kaldırabilirsiniz--)
                    </label>
                    <Field
                      component="select"
                      name="categoryIds"
...
export const VisualExamAssignForm = withRouter(VisualExamAssignForm_);
