...
export function CoursesTableLibraries() {
  // Courses UI Context
  ...
  const coursesUIProps = useMemo(() => {
    return {
      ...
      goLibraryCategoriesPage: coursesUIContext.goLibraryCategoriesPage,
  ...
  const columns = [
...

    {
      ...
      formatExtraData: {
        ...
        goLibraryCategoriesPage: coursesUIProps.goLibraryCategoriesPage,
