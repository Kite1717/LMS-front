...
export function ActionsColumnFormatterExam(
  cellContent,
  row,
  rowIndex,
  {
  ...
  return (
    <>
      <a
        ...
        onClick={() => openEditExamDialog(row.Id)}
      >
      ...
      <a
        ...
        onClick={() => openDeleteExamDialog(row.Id)}
      >
      ...
      <a
        ...
        onClick={() => openAssignExamDialog(row.Id, row.SuccessRate)}
      >
