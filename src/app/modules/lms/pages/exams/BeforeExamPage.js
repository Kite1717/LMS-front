...
import "./BeforeExamPage.scss";

export const BeforeExamPage = ({ history, location }) => {
        ...
        <Row>
          ...
          <Col lg={6}>
                  ...
                  if (result.value) {
                    ...
                    if (location.state.ExamCode) {
                      axios
                        ...
                        .then((res) =>
                          history.push(
                            `/lms/exam/ExamStart/${location.state.ExamCode}`
                          )
                        );
                    }
                  }
            ...
            <Button onClick = {()=>  history.push(
                            `/dashboard`
                          )}   variant="danger ml-2">Vazgeç</Button>
          </Col>
        </Row>
      </div>
    </>
